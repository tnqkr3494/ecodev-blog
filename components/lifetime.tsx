  ...
  return (
    <ul className="timeline timeline-vertical">
      <li>
        ...
        <div className="timeline-end timeline-box">born in jeju</div>
        <hr />
      </li>
      <li>
        <hr />
        ...
        <div className="timeline-end timeline-box">change</div>
        <hr />
      </li>
      <li>
        <hr />
        ...
        <div className="timeline-end timeline-box">start front</div>
        <hr />
      </li>
      <li>
        <hr />
      ...
      <li>
        ...
        <div className="timeline-end timeline-box">ts&next</div>
      </li>
    </ul>
  );
}
